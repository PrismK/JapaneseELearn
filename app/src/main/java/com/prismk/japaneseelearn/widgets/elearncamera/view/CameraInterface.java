...
import com.prismk.japaneseelearn.widgets.elearncamera.util.AngleUtil;
import com.prismk.japaneseelearn.widgets.elearncamera.util.CameraParamUtil;
import com.prismk.japaneseelearn.widgets.elearncamera.util.CheckPermission;
import com.prismk.japaneseelearn.widgets.elearncamera.util.DeviceUtil;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    //视频质量
    private int mediaQuality = ElearnCamera.MEDIA_QUALITY_MIDDLE;
    ...
    public void setSwitchView(ImageView mSwitchView, ImageView mFlashLamp, ImageView mBackView, Button flashAuto, Button flashOff, Button flashOpen) {
        this.mSwitchView = mSwitchView;
        this.mFlashLamp = mFlashLamp;
        this.mBackView = mBackView;
        this.flashAuto = flashAuto;
        this.flashOff = flashOff;
        this.flashOpen = flashOpen;
        if (mSwitchView != null) {
    ...
    private SensorEventListener sensorEventListener = new SensorEventListener() {
        public void onSensorChanged(SensorEvent event) {
            ...
            angle = AngleUtil.getSensorAngleSlowly(values[0], values[1]);
            //rotationAnimation();
    ...
    private void rotationAnimation() {
        ...
        if (rotation != angle) {
            ...
            ObjectAnimator animB = ObjectAnimator.ofFloat(mBackView, "rotation", start_rotaion, end_rotation);
            ObjectAnimator animAuto = ObjectAnimator.ofFloat(flashAuto, "rotation", start_rotaion, end_rotation);
            ObjectAnimator animOff = ObjectAnimator.ofFloat(flashOff, "rotation", start_rotaion, end_rotation);
            ObjectAnimator animOpen = ObjectAnimator.ofFloat(flashOpen, "rotation", start_rotaion, end_rotation);
            AnimatorSet set = new AnimatorSet();
            set.playTogether(animC, animF, animB, animAuto, animOff, animOpen);
            set.setDuration(500);
            set.start();
            rotation = angle;
        }
    ...
    private void angleRotationAnimation() {
        if (mSwitchView == null) {
            return;
        }
        if (rotation != angle) {
    ...
    public void setFlashMode(String flashMode) {
        ...
        //HuaWei setParameters Failed crash
        try {
            mCamera.setParameters(params);
        } catch (Exception e) {
            e.printStackTrace();
...
//        }
    ...
    private static Rect calculateTapArea(float x, float y, float coefficient, Context context) {
        ...
        int left = clamp(centerX - areaSize / 2, -1000, 500);
