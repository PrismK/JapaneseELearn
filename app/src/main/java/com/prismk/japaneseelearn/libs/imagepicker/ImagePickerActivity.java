...
import com.prismk.japaneseelearn.libs.imagepicker.imageloader.PicassoImageLoader;
import com.prismk.japaneseelearn.libs.imagepicker.imageloader.UILImageLoader;
import com.prismk.japaneseelearn.libs.imagepicker.imageloader.XUtils3ImageLoader;
...
public class ImagePickerActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lib_imagepicker_activity_image_picker);
