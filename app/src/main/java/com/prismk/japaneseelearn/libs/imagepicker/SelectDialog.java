package com.prismk.japaneseelearn.libs.imagepicker;
...
public class SelectDialog extends Dialog implements OnClickListener,OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = getLayoutInflater().inflate(R.layout.lib_imagepicker_view_dialog_select,
                null);
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (null == convertView) {
                ...
                convertView=layoutInflater.inflate(R.layout.lib_imagepicker_view_dialog_item, null);
            ...
            if (1 == mStrings.size()) {
                ...
                viewholder.dialogItemButton.setBackgroundResource(R.drawable.lib_imagepicker_dialog_item_bg_only);
            } else if (position == 0) {
                viewholder.dialogItemButton.setTextColor(mFirstItemColor);
                viewholder.dialogItemButton.setBackgroundResource(R.drawable.lib_imagepicker_select_dialog_item_bg_top);
            } else if (position == mStrings.size() - 1) {
                viewholder.dialogItemButton.setTextColor(mOtherItemColor);
                viewholder.dialogItemButton.setBackgroundResource(R.drawable.lib_imagepicker_select_dialog_item_bg_buttom);
            } else {
                viewholder.dialogItemButton.setTextColor(mOtherItemColor);
                viewholder.dialogItemButton.setBackgroundResource(R.drawable.lib_imagepicker_select_dialog_item_bg_center);
            }
            return convertView;
        }
